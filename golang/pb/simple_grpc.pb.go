...
type SimpleServiceClient interface {
	WhereAmI(ctx context.Context, in *Address, opts ...grpc.CallOption) (*Location, error)
}
...
func (c *simpleServiceClient) WhereAmI(ctx context.Context, in *Address, opts ...grpc.CallOption) (*Location, error) {
	out := new(Location)
	err := c.cc.Invoke(ctx, "/simple.SimpleService/WhereAmI", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SimpleServiceServer interface {
	WhereAmI(context.Context, *Address) (*Location, error)
}
...
func (UnimplementedSimpleServiceServer) WhereAmI(context.Context, *Address) (*Location, error) {
...
func _SimpleService_WhereAmI_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Address)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SimpleServiceServer).WhereAmI(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/simple.SimpleService/WhereAmI",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimpleServiceServer).WhereAmI(ctx, req.(*Address))
	}
...
var SimpleService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "WhereAmI",
			Handler:    _SimpleService_WhereAmI_Handler,
		},
	},
